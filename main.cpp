...
void rook11(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float cube_x, float cube_y, float cube_z,
	float cube_height, float cube_w, float cube_b, float r, float g, float b);
...
void pawn13(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float cube_x, float cube_y, float cube_z,
	float cube_height, float cube_w, float cube_b, float sphere_x, float sphere_y, float sphere_z, float sphere_height, float sphere_w,
	float sphere_b, float r, float g, float b);

void pawn14(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float cube_x, float cube_y, float cube_z,
	float cube_height, float cube_w, float cube_b, float sphere_x, float sphere_y, float sphere_z, float sphere_height, float sphere_w,
	float sphere_b, float r, float g, float b);

void pawn15(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float cube_x, float cube_y, float cube_z,
	float cube_height, float cube_w, float cube_b, float sphere_x, float sphere_y, float sphere_z, float sphere_height, float sphere_w,
	float sphere_b, float r, float g, float b);

void pawn16(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float cube_x, float cube_y, float cube_z,
	float cube_height, float cube_w, float cube_b, float sphere_x, float sphere_y, float sphere_z, float sphere_height, float sphere_w,
	float sphere_b, float r, float g, float b);
	*/
...
void knight1(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float x, float y, float z, float h,
	float w, float b, float r, float g, float bl);
void knight2(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float x, float y, float z, float h,
	float w, float b, float r, float g, float bl);
void knight3(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float x, float y, float z, float h, float w,
	float b, float r, float g, float bl);
void knight4(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float x, float y, float z, float h, float w,
	float b, float r, float g, float bl);
...
bool pressForPawn13 = false;
bool pressForPawn14 = false;
bool pressForPawn15 = false;
bool pressForPawn16 = false;
...
bool gameMode = false;
bool isBlackView = true;  // Track which view we're in during game mode

// Black pieces camera position
/*glm::vec3 blackPiecesView(0.977946f, 4.18149f, 5.92904f);
float blackPiecesPitch = 40.0f;
float blackPiecesYaw = 90.0f;*/

glm::vec3 blackPiecesView(0.977946f, 4.18149f, 5.92904f);
float blackPiecesPitch = 40.0f;
float blackPiecesYaw = 90.0f;

// White pieces camera position
glm::vec3 whitePiecesView(0.91073f, 3.67386f, -3.18804f);
float whitePiecesPitch = 40.0f;
float whitePiecesYaw = -90.0f;
...
float zForPawn15Cube = 0.8125, zForPawn16Cube = 0.8125;
...
float zForPawn15Sphere = 0.875f, zForPawn16Sphere = 0.875f;


float zForPawn7Cube2 = 2.0625f, zForPawn8Cube2 = 2.0625f, zForPawn9Cube2 = 2.0625f, zForPawn10Cube2 = 2.0625f, zForPawn11Cube2 = 2.0625f, zForPawn12Cube2 = 2.0625f, zForPawn13Cube2 = 2.0625f, zForPawn14Cube2 = 2.0625;
...
float zForPawn13Sphere2 = 0.875f + 1.25f, zForPawn14Sphere2 = 0.875f + 1.25f;
...
float xForKnight1 = xForBishop1 - 0.25f, zForKnight1 = zForBishop1, yForKnight1 = yForBishop1;
float xForKnight1Cube = xForBishop1Cube - 0.25f, yForKnight1Cube = yForBishop1Cube, zForKnight1Cube = zForBishop1Cube;
...
void startTransition(glm::vec3 start, glm::vec3 end,
	float startP, float endP,
...
// Smoothstep function for smoother acceleration/deceleration
...
void updateCameraTransition(float deltaTime)
{
	...
	else
	{
		...
		t = smoothstep(t);
		camera.Position = startPosition * (1.0f - t) + targetPosition * t;
		camera.Pitch = startPitch * (1.0f - t) + targetPitch * t;
		camera.Yaw = startYaw * (1.0f - t) + targetYaw * t;
	}
...
int main()
{
	...
	cout << "press F1,F2,F3,F4,F5,F6,F7,F8 and UP for pawn 1,2,3,4,5,6,7,8" << endl;
	cout << "press F1,F2,F3,F4,F5,F6,F7,F8 and DOWN for pawn 9,10,11,12,13,14,15,16" << endl;
...
// ------------------------------------
	...
	string diffuseMapPath = "floor3.jpg";
	...
	////////////////
	string diffuseMapPath2 = "wall2.jpg";
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//glm::mat4 view2 = basic_camera.createViewMatrix();
		//lightingShader.setMat4("view", view);
		...
		queen1(bezierVAOforAll, cubeVAO, lightingShader, modelForQueen, xforQueen1, 0.175f, zforQueen1, 0.10f, 0.20f, 0.10f, 0.824, 0.706, 0.549);
		...
		//king1(bezierVAOforAll, cubeVAO, lightingShader, modelForKing, xforKing1, yforKing1, zforKing1, 0.10f, 0.20f, 0.10f, 0.824, 0.706, 0.549,xForKing1Cube,yForKing1Cube,zForKing1Cube);
		...
		//rook1(cubeVAO, lightingShader, modelForKing, xforRook1,-0.125f,zforRook1,0.15,0.1,0.1, 0.824, 0.706, 0.549);
		//rook2(cubeVAO, lightingShader, modelForKing, xforRook2,-0.125f,zforRook2,0.15,0.1,0.1, 0.824, 0.706, 0.549);
		...
		//rook11(bezierVAOforAll, cubeVAO, lightingShader, modelForKing, xforRook1, -0.125f, zforRook1, 0.15, 0.1, 0.1, 0.824, 0.706, 0.549);
		...
		//pawn1(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 0.3125f, 0.25f, zForPawn1Cube, 0.15, 0.25, 0.15f, 0.125f + 0.25f, 0.525f, zForPawn1Sphere, 0.05, 0.05, 0.05f, 1.0, 1.0, 1.0);
		//pawn1(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 0.5625f, 0.25f, zForPawn1Cube, 0.15, 0.25, 0.15f, 0.125f + 0.25f * 2, 0.525f, zForPawn1Sphere, 0.05, 0.05, 0.05f, 1.0, 1.0, 1.0);
		//pawn1(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 0.8125f, 0.25f, zForPawn1Cube, 0.15, 0.25, 0.15f, 0.125f + 0.25f * 3, 0.525f, zForPawn1Sphere, 0.05, 0.05, 0.05f, 1.0, 1.0, 1.0);
		//pawn1(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 1.0625f, 0.25f, zForPawn1Cube, 0.15, 0.25, 0.15f, 0.125f + 0.25f * 4, 0.525f, zForPawn1Sphere, 0.05, 0.05, 0.05f, 1.0, 1.0, 1.0);
		//pawn1(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 1.3125f, 0.25f, zForPawn1Cube, 0.15, 0.25, 0.15f, 0.125f + 0.25f * 5, 0.525f, zForPawn1Sphere, 0.05, 0.05, 0.05f, 1.0, 1.0, 1.0);
		//pawn1(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 1.5625f, 0.25f, zForPawn1Cube, 0.15, 0.25, 0.15f, 0.125f + 0.25f * 6, 0.525f, zForPawn1Sphere, 0.05, 0.05, 0.05f, 1.0, 1.0, 1.0);
		//pawn1(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 1.8125f, 0.25f, zForPawn1Cube, 0.15, 0.25, 0.15f, 0.125f + 0.25f * 7, 0.525f, zForPawn1Sphere, 0.05, 0.05, 0.05f, 1.0, 1.0, 1.0);
		...
		//pawn15(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 1.5625, 0.25f, zForPawn15Cube, 0.15, 0.25, 0.15f, 0.125f + 0.25 * 5.0, 0.525f, zForPawn15Sphere, 0.05, 0.05, 0.05f, 1.0, 1.0, 1.0);
		//pawn16(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 1.8125, 0.25f, zForPawn16Cube, 0.15, 0.25, 0.15f, 0.125f + 0.25 * 5.0, 0.525f, zForPawn16Sphere, 0.05, 0.05, 0.05f, 1.0, 1.0, 1.0);


		
		
		pawn7(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 0.0625f, 0.25f, zForPawn7Cube2, 0.15, 0.25, 0.15f, 0.125f, 0.525f, zForPawn7Sphere2, 0.05, 0.05, 0.05f, 0.824, 0.706, 0.549);
		//pawn7(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 0.3125f, 0.25f, zForPawn7Cube2, 0.15, 0.25, 0.15f, 0.125f + 0.25f, 0.525f, zForPawn7Sphere2, 0.05, 0.05, 0.05f, 0.824, 0.706, 0.549);
		//pawn7(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 0.5625f, 0.25f, zForPawn7Cube2, 0.15, 0.25, 0.15f, 0.125f + 0.25f * 2, 0.525f, zForPawn7Sphere2, 0.05, 0.05, 0.05f, 0.824, 0.706, 0.549);
		//pawn7(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 0.8125f, 0.25f, zForPawn7Cube2, 0.15, 0.25, 0.15f, 0.125f + 0.25f * 3, 0.525f, zForPawn7Sphere2, 0.05, 0.05, 0.05f, 0.824, 0.706, 0.549);
		//pawn7(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 1.0625f, 0.25f, zForPawn7Cube2, 0.15, 0.25, 0.15f, 0.125f + 0.25f * 4, 0.525f, zForPawn7Sphere2, 0.05, 0.05, 0.05f, 0.824, 0.706, 0.549);
		//pawn7(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 1.3125f, 0.25f, zForPawn7Cube2, 0.15, 0.25, 0.15f, 0.125f + 0.25f * 5, 0.525f, zForPawn7Sphere2, 0.05, 0.05, 0.05f, 0.824, 0.706, 0.549);
		//pawn7(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 1.5625f, 0.25f, zForPawn7Cube2, 0.15, 0.25, 0.15f, 0.125f + 0.25f * 6, 0.525f, zForPawn7Sphere2, 0.05, 0.05, 0.05f, 0.824, 0.706, 0.549);
		//pawn7(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 1.8125f, 0.25f, zForPawn7Cube2, 0.15, 0.25, 0.15f, 0.125f + 0.25f * 7, 0.525f, zForPawn7Sphere2, 0.05, 0.05, 0.05f, 0.824, 0.706, 0.549);
		
		//pawn8(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 0.3125f, 0.25f, zForPawn8Cube2, 0.15, 0.25, 0.15f, 0.125f + 0.25f, 0.525f, zForPawn8Sphere2, 0.05, 0.05, 0.05f, 0.824, 0.706, 0.549);
		//pawn9(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 0.5625f, 0.25f, zForPawn9Cube2, 0.15, 0.25, 0.15f, 0.125f + 0.25 * 2.0, 0.525f, zForPawn9Sphere2, 0.05, 0.05, 0.05f, 0.824, 0.706, 0.549);
		//pawn10(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 0.8125f, 0.25f, zForPawn10Cube2, 0.15, 0.25, 0.15f, 0.125f + 0.25 * 3.0, 0.525f, zForPawn10Sphere2, 0.05, 0.05, 0.05f, 0.824, 0.706, 0.549);
		//pawn11(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 1.0625f, 0.25f, zForPawn11Cube2, 0.15, 0.25, 0.15f, 0.125f + 0.25 * 4.0, 0.525f, zForPawn11Sphere2, 0.05, 0.05, 0.05f, 0.824, 0.706, 0.549);
		//pawn12(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 1.3125f, 0.25f, zForPawn12Cube2, 0.15, 0.25, 0.15f, 0.125f + 0.25 * 5.0, 0.525f, zForPawn12Sphere2, 0.05, 0.05, 0.05f, 0.824, 0.706, 0.549);
		//pawn13(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 1.5625, 0.25f, zForPawn13Cube2, 0.15, 0.25, 0.15f, 0.125f + 0.25 * 5.0, 0.525f, zForPawn13Sphere2, 0.05, 0.05, 0.05f, 0.824, 0.706, 0.549);
		//pawn14(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 1.8125, 0.25f, zForPawn14Cube2, 0.15, 0.25, 0.15f, 0.125f + 0.25 * 5.0, 0.525f, zForPawn14Sphere2, 0.05, 0.05, 0.05f, 0.824, 0.706, 0.449);

		// blue opponent -> 0.1, 0.5, 0.8
		...
		if (pressForPawn2)
		{
			...
			pawn1(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 0.3125f, 0.25f, zForPawn2Cube, 0.15, 0.25, 0.15f, 0.125f + 0.25f, 0.525f, zForPawn2Sphere, 0.05, 0.05, 0.05f, 1.0, 1.0, 1.0);
			pressForPawn2 = false;
		}
		if (pressForPawn3)
		{
			...
			pawn1(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 0.5625f, 0.25f, zForPawn3Cube, 0.15, 0.25, 0.15f, 0.125f + 0.25 * 2.0, 0.525f, zForPawn3Sphere, 0.05, 0.05, 0.05f, 1.0, 1.0, 1.0);
			pressForPawn3 = false;
		}
		if (pressForPawn4)
		{
			...
			pawn1(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 0.8125f, 0.25f, zForPawn4Cube, 0.15, 0.25, 0.15f, 0.125f + 0.25 * 3.0, 0.525f, zForPawn4Sphere, 0.05, 0.05, 0.05f, 1.0, 1.0, 1.0);
			pressForPawn4 = false;
		}
		if (pressForPawn5)
		{
			...
			pawn1(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 1.0625f, 0.25f, zForPawn5Cube, 0.15, 0.25, 0.15f, 0.125f + 0.25 * 4.0, 0.525f, zForPawn5Sphere, 0.05, 0.05, 0.05f, 1.0, 1.0, 1.0);
			pressForPawn5 = false;
		}
		if (pressForPawn6)
		{
			...
			pawn1(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 1.3125f, 0.25f, zForPawn6Cube, 0.15, 0.25, 0.15f, 0.125f + 0.25 * 5.0, 0.525f, zForPawn6Sphere, 0.05, 0.05, 0.05f, 1.0, 1.0, 1.0);
			pressForPawn6 = false;
		}
		...
		if (pressForPawn15)
		{
			zForPawn15Cube += 0.25f;
			zForPawn15Sphere += 0.25f;
			pawn1(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 1.5625f, 0.25f, zForPawn15Cube, 0.15, 0.25, 0.15f, 0.125f + 0.25 * 5.0, 0.525f, zForPawn6Sphere, 0.05, 0.05, 0.05f, 1.0, 1.0, 1.0);
			pressForPawn15 = false;
		}


		if (pressForPawn16)
		{
			zForPawn16Cube += 0.25f;
			zForPawn16Sphere += 0.25f;
			pawn1(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 1.8125f, 0.25f, zForPawn15Cube, 0.15, 0.25, 0.15f, 0.125f + 0.25 * 5.0, 0.525f, zForPawn6Sphere, 0.05, 0.05, 0.05f, 1.0, 1.0, 1.0);
			pressForPawn16 = false;
		}
		*/
		...
		if (pressForPawn13)
		{
			zForPawn13Cube2 -= 0.25f;
			zForPawn13Sphere2 -= 0.25f;
			pawn13(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 1.5625f, 0.25f, 2.0625f, 0.15, 0.25, 0.15f, 0.125f + 0.25 * 5.0, 0.525f, zForPawn12Sphere2, 0.05, 0.05, 0.05f, 0.1, 0.5, 0.8);
			pressForPawn13 = false;
		}

		if (pressForPawn14)
		{
			zForPawn14Cube2 -= 0.25f;
			zForPawn14Sphere2 -= 0.25f;
			pawn14(bezierVAOforAll, cubeVAO, lightingShader, modelForPawn, 1.8125f, 0.25f, 2.0625f, 0.15, 0.25, 0.15f, 0.125f + 0.25 * 5.0, 0.525f, zForPawn12Sphere2, 0.05, 0.05, 0.05f, 0.1, 0.5, 0.8);
			pressForPawn14 = false;
		}
		*/
		...
		bishop1(bezierVAOforAll, cubeVAO, lightingShader, modelforBishop, xForBishop1, 0.405f, zForBishop1,0.05f, 0.05f, 0.04f, 0.824, 0.706, 0.549, xForBishop1Cube, yForBishop1Cube, zForBishop1Cube);
		bishop2(bezierVAOforAll, cubeVAO, lightingShader, modelforBishop, xForBishop2, 0.405f, zForBishop2,0.05f, 0.05f, 0.04f, 0.824, 0.706, 0.549, xForBishop2Cube , yForBishop2Cube, zForBishop2Cube);
		...
		scaleMatrix = glm::scale(identityMatrix, glm::vec3(scale_X, scale_Y, scale_Z));
		modelforBishop = translateMatrix * rotateXMatrix * rotateYMatrix * rotateZMatrix * scaleMatrix;
		lightingShader.setMat4("model", modelforKnight);


		//knight1(bezierVAOforAll, cubeVAO, lightingShader, modelforBishop, xForKnight1, 0.405f, zForKnight1, 0.05f, 0.05f, 0.04f, 0.824, 0.706, 0.549, xForKnight1Cube, yForKnight1Cube, zForKnight1Cube);
		//knight1(bezierVAOforAll, cubeVAO, lightingShader, modelForQueen, xforQueen1, 0.175f, zforQueen1, 0.05f, 0.20f, 0.05f, 0.824, 0.706, 0.549);
		//knight2(bezierVAOforAll, cubeVAO, lightingShader, modelForQueen, xforQueen1, 0.175f, zforQueen1, 0.05f, 0.20f, 0.05f, 0.824, 0.706, 0.549);
		//knight3(bezierVAOforAll, cubeVAO, lightingShader, modelForQueen, xforQueen2, 0.175f, zforQueen2, 0.10f, 0.20f, 0.10f, 1.0, 1.0, 1.0);
		//knight4(bezierVAOforAll, cubeVAO, lightingShader, modelForQueen, xforQueen2, 0.175f, zforQueen2, 0.10f, 0.20f, 0.10f, 1.0, 1.0, 1.0);
		...
		// Chair seat
		glm::mat4 modelforChair = glm::mat4(1.0f);
		lightingShaderWithTexture.use();
		scale = glm::mat4(1.0f);
		translate = glm::mat4(1.0f);
		rotate = glm::mat4(1.0f);
		scale = glm::scale(modelforChair, glm::vec3(2.0f, 0.2f, 2.0f)); // Seat dimensions
		translate = glm::translate(modelforChair, glm::vec3(0.0f, -1.0f, -0.7f)); // Centered position
		modelforChair = translate * scale;
		cube.drawCubeWithTexture(lightingShaderWithTexture, modelforChair);

		// Chair backrest
		modelforChair = glm::mat4(1.0f);
		scale = glm::scale(modelforChair, glm::vec3(2.0f, 2.5f, 0.2f)); // Backrest dimensions
		translate = glm::translate(modelforChair, glm::vec3(0.0f, -1.0f, -0.9f)); // Positioned behind the seat
		modelforChair = translate * scale;
		cube.drawCubeWithTexture(lightingShaderWithTexture, modelforChair);

		// Chair front-left leg
		modelforChair = glm::mat4(1.0f);
		scale = glm::scale(modelforChair, glm::vec3(0.2f, 2.0f, 0.2f)); // Leg dimensions
		translate = glm::translate(modelforChair, glm::vec3(-0.0f, -2.0f, 0.8f)); // Front-left corner
		modelforChair = translate * scale;
		cube.drawCubeWithTexture(lightingShaderWithTexture, modelforChair);

		// Chair front-right leg
		modelforChair = glm::mat4(1.0f);
		scale = glm::scale(modelforChair, glm::vec3(0.2f, 2.0f, 0.2f)); // Leg dimensions
		translate = glm::translate(modelforChair, glm::vec3(1.7f, -2.0f, 0.8f)); // Front-right corner
		modelforChair = translate * scale;
		cube.drawCubeWithTexture(lightingShaderWithTexture, modelforChair);
		...
		modelforChair = glm::mat4(1.0f);
		scale = glm::scale(modelforChair, glm::vec3(0.2f, 2.0f, 0.2f)); // Leg dimensions
		translate = glm::translate(modelforChair, glm::vec3(-0.8f, -2.0f, -0.8f)); // Back-left corner
		modelforChair = translate * scale;
		cube.drawCubeWithTexture(lightingShaderWithTexture, modelforChair);

		// Chair back-right leg
		modelforChair = glm::mat4(1.0f);
		scale = glm::scale(modelforChair, glm::vec3(0.2f, 2.0f, 0.2f)); // Leg dimensions
		translate = glm::translate(modelforChair, glm::vec3(0.8f, -2.0f, -0.8f)); // Back-right corner
		modelforChair = translate * scale;
		cube.drawCubeWithTexture(lightingShaderWithTexture, modelforChair);
		...
		rotate = glm::mat4(1.0f);
		scale = glm::scale(modelforChair, glm::vec3(2.0f, 0.2f, 2.0f)); // Seat dimensions
		translate = glm::translate(modelforChair, glm::vec3(0.0f, -1.0f, 1.5f)); // Centered position
		modelforChair = translate * scale;
		cube.drawCubeWithTexture(lightingShaderWithTexture, modelforChair);

		// Chair backrest
		modelforChair = glm::mat4(1.0f);
		scale = glm::scale(modelforChair, glm::vec3(2.0f, 1.5f, 0.2f)); // Backrest dimensions
		translate = glm::translate(modelforChair, glm::vec3(0.0f, -1.0f, 3.5f)); // Positioned behind the seat
		modelforChair = translate * scale;
		cube.drawCubeWithTexture(lightingShaderWithTexture, modelforChair);
		...
		modelforChair = glm::mat4(1.0f);
		scale = glm::scale(modelforChair, glm::vec3(0.2f, 2.0f, 0.2f)); // Leg dimensions
		translate = glm::translate(modelforChair, glm::vec3(-0.0f, -2.0f, -1.5f)); // Front-left corner
		modelforChair = translate * scale;
		cube.drawCubeWithTexture(lightingShaderWithTexture, modelforChair);
		...
		modelforChair = glm::mat4(1.0f);
		scale = glm::scale(modelforChair, glm::vec3(0.2f, 2.0f, 0.2f)); // Leg dimensions
		translate = glm::translate(modelforChair, glm::vec3(1.7f, -2.0f, -1.5f)); // Front-right corner
		modelforChair = translate * scale;
		cube.drawCubeWithTexture(lightingShaderWithTexture, modelforChair);
		*/
		...
		modelforChair = glm::mat4(1.0f);
		scale = glm::scale(modelforChair, glm::vec3(0.2f, 2.0f, 0.2f)); // Leg dimensions
		translate = glm::translate(modelforChair, glm::vec3(-0.0f, -2.0f, 2.5f)); // Back-left corner
		modelforChair = translate * scale;
		cube.drawCubeWithTexture(lightingShaderWithTexture, modelforChair);
		...
		modelforChair = glm::mat4(1.0f);
		scale = glm::scale(modelforChair, glm::vec3(0.2f, 2.0f, 0.2f)); // Leg dimensions
		translate = glm::translate(modelforChair, glm::vec3(1.5f, -2.0f, 2.5f)); // Back-right corner
		modelforChair = translate * scale;
		cube.drawCubeWithTexture(lightingShaderWithTexture, modelforChair);
		...
		glm::mat4 modelforCupBoard = glm::mat4(1.0f);
		lightingShaderWithTexture.use();
		translate = glm::mat4(1.0f);
		scale = glm::mat4(1.0f);
		rotate = glm::mat4(1.0f);
		scale = glm::scale(modelforChessBoard, glm::vec3(8.0f, 8.0f, 4.0f));
		translate = glm::translate(modelforChessBoard, glm::vec3(1.75f, -0.50f, -5.50f));
		modelforCupBoard = scale * translate;
		cube.drawCubeWithTexture(lightingShaderWithTexture, modelforCupBoard);
		...
		string diffuseMapPathcylinder = "floor3.jpg";
		string specularMapPathculinder = "lamp1.jpg";


		unsigned int diffMapcylinder = loadTexture(diffuseMapPathcylinder.c_str(), GL_REPEAT, GL_REPEAT, GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR);
		unsigned int specMapcylinder = loadTexture(specularMapPathculinder.c_str(), GL_REPEAT, GL_REPEAT, GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR);

	   


		Cylinder cylinder = Cylinder(0.5f, 1.0f, 2.0f, 20.0f, 20.0f,
			glm::vec3(0.2f), glm::vec3(0.5f), glm::vec3(1.0f),
			32.0f, diffMapcylinder, specMapcylinder, specMapcylinder);

		glm::mat4 modelforLampcyilnder = glm::mat4(1.0f);
		lightingShaderWithTexture.use();
		translate = glm::mat4(1.0f);
		scale = glm::mat4(1.0f);
		rotate = glm::mat4(1.0f);
		scale = glm::scale(modelforChessBoard, glm::vec3(1.0f, 1.0f, 1.0f));
		translate = glm::translate(modelforChessBoard, glm::vec3(18.00f, 7.0f, -20.00f));
		modelforLampcyilnder = scale * translate;
		cylinder.drawTexture(lightingShaderWithTexture, modelforLampcyilnder);

		
		


		/*glm::mat4 modelforLampHead = glm::mat4(1.0f);
		lightingShaderWithTexture.use();
		translate = glm::mat4(1.0f);
		scale = glm::mat4(1.0f);
		rotate = glm::mat4(1.0f);
		scale = glm::scale(modelforChessBoard, glm::vec3(1.0f, 1.0f, 1.0f));
		translate = glm::translate(modelforChessBoard, glm::vec3(18.00f, 8.0f, -20.00f));
		modelforLampHead = scale * translate;
		cylinder.drawTexture(lightingShaderWithTexture, modelforLampHead);*/

		
		/*string diffuseMapPathHead = "paperhead.jpg";
		unsigned int diffMaphead = loadTexture(diffuseMapPathHead.c_str(), GL_REPEAT, GL_REPEAT, GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR);
		Cylinder head = Cylinder(1.0f, 2.0f, 2.25f, 20.0f, 108.0f, glm::vec3(0.2f), glm::vec3(0.5f), glm::vec3(1.0f), 32.0f, diffMaphead, diffMaphead, diffMaphead);
		*/

		/*string diffuseMapPathStick = "plastic.jpg";
		unsigned int diffMapStick = loadTexture(diffuseMapPathStick.c_str(), GL_REPEAT, GL_REPEAT, GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR);
		Cylinder stick = Cylinder(0.25f, 0.25f, 2.50f, 20.0f, 108.0f, glm::vec3(0.2f), glm::vec3(0.5f), glm::vec3(1.0f), 32.0f, diffMapStick, diffMapStick, diffMapStick);

		string diffuseMapPathBase = "plastic.jpg";
		unsigned int diffMapBase = loadTexture(diffuseMapPathBase.c_str(), GL_REPEAT, GL_REPEAT, GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR);
		Cylinder base = Cylinder(2.0f, 2.0f, 0.50f, 20.0f, 108.0f, glm::vec3(0.2f), glm::vec3(0.5f), glm::vec3(1.0f), 32.0f, diffMapBase, diffMapBase, diffMapBase);
		*/

		/*
		// lamp head
		glm::mat4 modelforHead = glm::mat4(1.0f);
		lightingShaderWithTexture.use();
		translate = glm::mat4(1.0f);
		scale = glm::mat4(1.0f);
		rotate = glm::mat4(1.0f);
		scale = glm::scale(modelforChessBoard, glm::vec3(1.0f, 1.0f, 1.0f));
		translate = glm::translate(modelforChessBoard, glm::vec3(18.00f, 8.0f, -20.00f));
		modelforHead = scale * translate;
		head.drawTexture(lightingShaderWithTexture, modelforHead);*/

		// lamp stick
		/*glm::mat4 modelforStick = glm::mat4(1.0f);
		lightingShaderWithTexture.use();
		translate = glm::mat4(1.0f);
		scale = glm::mat4(1.0f);
		rotate = glm::mat4(1.0f);
		scale = glm::scale(modelforChessBoard, glm::vec3(0.3f, 0.5f, 0.2f));
		translate = glm::translate(modelforChessBoard, glm::vec3(27.00f, 8.0f, -20.00f));
		modelforStick = scale * translate;
		stick.drawTexture(lightingShaderWithTexture, modelforStick);
		*/

		/*glm::mat4 modelforLampStick = glm::mat4(1.0f);
		lightingShaderWithTexture.use();
		translate = glm::mat4(1.0f);
		scale = glm::mat4(1.0f);
		rotate = glm::mat4(1.0f);
		scale = glm::scale(modelforChessBoard, glm::vec3(1.0f, 1.0f, 1.0f));
		translate = glm::translate(modelforChessBoard, glm::vec3(18.00f, 5.5f, -20.00f));
		modelforLampStick = scale * translate;
		stick.drawTexture(lightingShaderWithTexture, modelforLampStick);


		glm::mat4 modelforLampBase = glm::mat4(1.0f);
		lightingShaderWithTexture.use();
		translate = glm::mat4(1.0f);
		scale = glm::mat4(1.0f);
		rotate = glm::mat4(1.0f);
		scale = glm::scale(modelforChessBoard, glm::vec3(1.0f, 1.0f, 1.0f));
		translate = glm::translate(modelforChessBoard, glm::vec3(18.00f, 4.0f, -20.0f));
		modelforLampBase = scale * translate;
		base.drawTexture(lightingShaderWithTexture, modelforLampBase);
		*/
		...
		translate = glm::mat4(1.0f);
		scale = glm::mat4(1.0f);
		translate = glm::translate(modelforClock, glm::vec3(0.300f, 0.8125f, -21.50f));
		...
		string diffuseMapfan = "wall11.jpg";
		string specularMapfan = "lamp1.jpg";


		unsigned int diffMapfan = loadTexture(diffuseMapfan.c_str(), GL_REPEAT, GL_REPEAT, GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR);
		unsigned int specMapfan = loadTexture(specularMapfan.c_str(), GL_REPEAT, GL_REPEAT, GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR);



		/*
		Cylinder cylinderfan = Cylinder(1.0f, 1.0f, 2.0f, 20.0f, 20.0f,
			glm::vec3(0.2f), glm::vec3(0.5f), glm::vec3(1.0f),
			32.0f, diffMapfan, specMapfan, specMapfan);

		//fan base
		glm::mat4 modelforfanBase = glm::mat4(1.0f);
		lightingShaderWithTexture.use();
		translate = glm::mat4(1.0f);
		scale = glm::mat4(1.0f);
		rotate = glm::mat4(1.0f);
		scale = glm::scale(modelforChessBoard, glm::vec3(1.0f, 0.1f, 1.0f));
		translate = glm::translate(modelforChessBoard, glm::vec3(0.0f, 25.0f, -0.7f));
		modelforfanBase = scale * translate;
		cube.drawCube(lightingShaderWithTexture, modelforfanBase);*/
		...
		// fan
		/*lightingShaderWithTexture.use();
		glm:: mat4 modelforFan = glm::mat4(1.0f);
		translate = glm::mat4(1.0f);
		scale = glm::mat4(1.0f);
		scale = glm::scale(modelforTable, glm::vec3(0.8f, 0.0f, 0.3f));
		translate = glm::translate(modelforTable, glm::vec3(-0.25f, -0.25f, -0.20f));
		modelforTable = translate * scale;
		cube.drawCubeWithTexture(lightingShaderWithTexture, modelforFan);*/
...
void queen1(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float x, float y, float z, float h, float w,
	...
	glm::mat4 scale = glm::mat4(1.0f);
	glm::mat4 rotate = glm::mat4(1.0f);
	translate = glm::translate(modelForQueen, glm::vec3(x + 0.5f, y, z));
	...
	rotate = glm::mat4(1.0f);
	modelForQueen = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelForQueen, x + 0.5f, 0.60, z, 0.09f, 0.03f, 0.09f, r, g, bl);
	...
	rotate = glm::mat4(1.0f);
	modelForQueen = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelForQueen, x + 0.5f, 0.505, z, 0.105f, 0.045f, 0.105f, r, g, bl);
	...
	rotate = glm::mat4(1.0f);
	modelForQueen = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelForQueen, x + 0.5f, 0.325, z, 0.15f, 0.075f, 0.15f, r, g, bl);
	...
	rotate = glm::mat4(1.0f);
	modelForQueen = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelForQueen, x + 0.5f, 0.625, z, 0.04f, 0.04f, 0.04f, r, g, bl);
}
...
void pawn1(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float cube_x, float cube_y, float cube_z,
	...
	glm::mat4 scale = glm::mat4(1.0f);
	glm::mat4 rotate = glm::mat4(1.0f);
	translate = glm::translate(modelforPawn, glm::vec3(cube_x + 0.0625, cube_y, cube_z + 0.0675)); // middle part
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	modelforPawn = alTogether * translate * scale;  // 2nd part
	drawSphere(lightingShader, alTogether * modelforPawn, sphere_x, sphere_y - 0.190f, sphere_z, 0.10f, 0.050f, 0.10f, 1.0, 1.0, 1.0);

	modelforPawn = glm::mat4(1.0f);
	identityMatrix = glm::mat4(1.0f); // make sure to initialize matrix to identity matrix first
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);                            // lower part
	modelforPawn = alTogether * translate * scale;
...
void bishop1(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float x, float y, float z, float h, float w,
	...
	glm::mat4 scale = glm::mat4(1.0f);
	glm::mat4 rotate = glm::mat4(1.0f);
	translate = glm::translate(modelForBishop, glm::vec3(x - 0.01f + 0.25f, y + 0.055, z));
	...
	rotate = glm::mat4(1.0f);
	modelForBishop = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelForBishop, xForBishop1 - 0.01f + 0.25f, yForBishop1 + 0.165f, zForBishop1, 0.0365f, 0.0365f, 0.0365f, 0.824, 0.706, 0.549);
	...
	rotate = glm::mat4(1.0f);
	modelForBishop = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelForBishop, xForBishop1 + 0.25f, yForBishop1 - 0.105f, zForBishop1 - 0.01f, 0.2f, 0.01f, 0.2f, 0.824, 0.706, 0.549);
	...
	rotate = glm::mat4(1.0f);
	modelForBishop = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelForBishop, xForBishop1 - 0.01 + 0.25f, yForBishop1 + 0.085f, zForBishop1, 0.15f, 0.05f, 0.15f, 0.824, 0.706, 0.549);

	modelForBishop = glm::mat4(1.0f);
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	rotate = glm::mat4(1.0f);
	translate = glm::translate(modelForBishop, glm::vec3(xForBishop1Cube + 0.25f, yForBishop1Cube, zForBishop1Cube));
...
void clock1(unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether) {
	...
	angle_r = fmod(angle_r - speed, 360.0f);
	...
	translate = glm::translate(modelforClock, glm::vec3(1.2, 1.9, -21.0));
	modelforClock = alTogether * translate * rotate * scale;
	drawCube(cubeVAO, lightingShader, modelforClock, 1.0f, 1.0f, 1.0f);
...
{   ///////////////////////////////bishop's moves
	...
	if (glfwGetKey(window, GLFW_KEY_F7) && glfwGetKey(window, GLFW_KEY_UP) == GLFW_PRESS)
	{
		if (!pressForPawn15)
			pressForPawn15 = true;
	}
	if (glfwGetKey(window, GLFW_KEY_F8) && glfwGetKey(window, GLFW_KEY_UP) == GLFW_PRESS)
	{
		if (!pressForPawn16)
			pressForPawn16 = true;
	}

	if (glfwGetKey(window, GLFW_KEY_F1) && glfwGetKey(window, GLFW_KEY_DOWN) == GLFW_PRESS)
	{
		if (!pressForPawn7)
			pressForPawn7 = true;

	}
	if (glfwGetKey(window, GLFW_KEY_F2) && glfwGetKey(window, GLFW_KEY_DOWN) == GLFW_PRESS)
	{
		if (!pressForPawn8)
			pressForPawn8 = true;

	}
	if (glfwGetKey(window, GLFW_KEY_F3) && glfwGetKey(window, GLFW_KEY_DOWN) == GLFW_PRESS)
	{
		if (!pressForPawn9)
			pressForPawn9 = true;
	...
	if (glfwGetKey(window, GLFW_KEY_F4) && glfwGetKey(window, GLFW_KEY_DOWN) == GLFW_PRESS)
	{
		if (!pressForPawn10)
			pressForPawn10 = true;

	}   if (glfwGetKey(window, GLFW_KEY_F5) && glfwGetKey(window, GLFW_KEY_DOWN) == GLFW_PRESS)
	{
		if (!pressForPawn11)
			pressForPawn11 = true;
	...
	if (glfwGetKey(window, GLFW_KEY_F7) && glfwGetKey(window, GLFW_KEY_DOWN) == GLFW_PRESS)
	{
		if (!pressForPawn13)
			pressForPawn13 = true;
	...
	if (glfwGetKey(window, GLFW_KEY_G) && glfwGetKey(window, GLFW_KEY_UP) == GLFW_PRESS)
	{
		gameMode = !gameMode;
		if (gameMode)
		{
			// Start transition to black view
			startTransition(camera.Position, blackPiecesView,
				camera.Pitch, blackPiecesPitch,
				camera.Yaw, blackPiecesYaw);
			isBlackView = true;
		}
	}

	if (gameMode && key == GLFW_KEY_M && action == GLFW_PRESS && !isTransitioning)
	{
		...
		{
			startTransition(camera.Position, whitePiecesView,
				camera.Pitch, whitePiecesPitch,
				camera.Yaw, whitePiecesYaw);
		}
	}
...
unsigned int hollowBezier(GLfloat ctrlpoints[], int L)
{
	...
	const float dtheta = 2 * pi2 / ntheta;        //angular step size
...
void pawn6(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float cube_x, float cube_y, float cube_z,
	...
	scale = glm::mat4(1.0f);
	modelforPawn = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelforPawn, sphere_x, sphere_y - .190f, sphere_z, 0.10f, 0.050f, 0.10f, 1.0, 1.0, 1.0);
...
void pawn15(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float cube_x, float cube_y, float cube_z,
	...
	scale = glm::mat4(1.0f);
	modelforPawn = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelforPawn, sphere_x + 0.25, sphere_y + 0.025, sphere_z, sphere_height, sphere_w, sphere_b, 1.0, 1.0, 1.0);
	...
	scale = glm::mat4(1.0f);
	modelforPawn = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelforPawn, sphere_x + 0.25, sphere_y - 0.190f, sphere_z, 0.10f, 0.050f, 0.10f, 1.0, 1.0, 1.0);
	...
	scale = glm::mat4(1.0f);
	modelforPawn = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelforPawn, sphere_x + 0.25, sphere_y - 0.015, sphere_z, 0.08f, 0.025f, 0.08f, 1.0, 1.0, 1.0);
...
void pawn16(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float cube_x, float cube_y, float cube_z,
	...
	scale = glm::mat4(1.0f);
	modelforPawn = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelforPawn, sphere_x + 0.5, sphere_y + 0.025, sphere_z, sphere_height, sphere_w, sphere_b, 1.0, 1.0, 1.0);
	...
	scale = glm::mat4(1.0f);
	modelforPawn = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelforPawn, sphere_x + 0.5, sphere_y - 0.190f, sphere_z, 0.10f, 0.050f, 0.10f, 1.0, 1.0, 1.0);
	...
	scale = glm::mat4(1.0f);
	modelforPawn = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelforPawn, sphere_x + 0.5, sphere_y - 0.015, sphere_z, 0.08f, 0.025f, 0.08f, 1.0, 1.0, 1.0);
...
void pawn7(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float cube_x, float cube_y, float cube_z,
	...
	scale = glm::mat4(1.0f);
	modelforPawn = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelforPawn, sphere_x, sphere_y - 0.190f, sphere_z, 0.10f, 0.050f, 0.10f, r, g, b);
...
void pawn13(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float cube_x, float cube_y, float cube_z,
	...
	scale = glm::mat4(1.0f);
	modelforPawn = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelforPawn, sphere_x + 0.25, sphere_y + 0.025, sphere_z, sphere_height, sphere_w, sphere_b, r, g, b);
	...
	scale = glm::mat4(1.0f);
	modelforPawn = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelforPawn, sphere_x + 0.25, sphere_y - 0.190f, sphere_z, 0.10f, 0.050f, 0.10f, r, g, b);
	...
	scale = glm::mat4(1.0f);
	modelforPawn = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelforPawn, sphere_x + 0.25, sphere_y - 0.015, sphere_z, 0.08f, 0.025f, 0.08f, r, g, b);
...
void pawn14(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float cube_x, float cube_y, float cube_z,
	...
	scale = glm::mat4(1.0f);
	modelforPawn = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelforPawn, sphere_x + 0.5, sphere_y + 0.025, sphere_z, sphere_height, sphere_w, sphere_b, r, g, b);
	...
	scale = glm::mat4(1.0f);
	modelforPawn = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelforPawn, sphere_x + 0.5, sphere_y - 0.190f, sphere_z, 0.10f, 0.050f, 0.10f, r, g, b);
	...
	scale = glm::mat4(1.0f);
	modelforPawn = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelforPawn, sphere_x + 0.5, sphere_y - 0.015, sphere_z, 0.08f, 0.025f, 0.08f, r, g, b);
...
void bishop2(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float x, float y, float z, float h, float w,
	...
	rotate = glm::mat4(1.0f);
	modelForBishop = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelForBishop, x - 0.01f + 0.25f, y + 0.165f, z, 0.0365f, 0.0365f, 0.0365f, r, g, bl);
	...
	rotate = glm::mat4(1.0f);
	modelForBishop = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelForBishop, x + 0.25f, y - 0.105f, z - 0.01f, 0.2f, 0.01f, 0.2f, r, g, bl);
	...
	rotate = glm::mat4(1.0f);
	modelForBishop = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelForBishop, x - 0.01f + 0.25f, y + 0.085f, z, 0.15f, 0.05f, 0.15f, r, g, bl);

	modelForBishop = glm::mat4(1.0f);
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	rotate = glm::mat4(1.0f);
	translate = glm::translate(modelForBishop, glm::vec3(cube_x + 0.25f, cube_y, cube_z));
	scale = glm::scale(modelForBishop, glm::vec3(0.10f, 0.25f, 0.10f));
	modelForBishop = alTogether * translate * scale;
	drawCube(cubeVAO, lightingShader, alTogether * modelForBishop, r, g, bl);
...
void bishop3(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float x, float y, float z, float h, float w,
	...
	rotate = glm::mat4(1.0f);
	modelForBishop = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelForBishop, x - 0.01 + 0.25f, y + 0.085f, z, 0.15f, 0.05f, 0.15f, r, g, bl);
...
void rook11(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float cube_x, float cube_y, float cube_z,
	...
	glm::mat4 rotate;
	rotate = glm::rotate(identityMatrix, glm::radians(rotateAngle_X), glm::vec3(1.0f, 0.0f, 0.0f));
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.05 + 0.25, cube_y + 0.40, cube_z + 0.75));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height, cube_w, cube_b));
	modelForPawn = alTogether * translate * scale;
	lightingShader.setMat4("model", modelForPawn);
	drawCurve(bezierVAO, lightingShader, modelForPawn, r, g, b);
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.08 + 0.25, cube_y + 0.5, cube_z + 0.75));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.055, cube_w + 0.025, cube_b));
	modelForPawn = alTogether * translate * scale;
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.065 + 0.25, cube_y + 0.6, cube_z + 0.725));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.025, cube_w - 0.05, cube_b + 0.05));
	modelForPawn = alTogether * translate * scale;
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.065 + 0.25, cube_y + 0.65, cube_z + 0.725));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b + 0.05));
	modelForPawn = alTogether * translate * scale;
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.065 + 0.25, cube_y + 0.68, cube_z + 0.725));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b - 0.06));
	modelForPawn = alTogether * translate * scale;
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.065 + 0.25, cube_y + 0.68, cube_z + 0.86 - 0.025));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b - 0.06));
	modelForPawn = alTogether * translate * scale;
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.065 + .115 + 0.25, cube_y + 0.65, cube_z + 0.725));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b + 0.05));
	modelForPawn = alTogether * translate * scale;
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.065 + .115 + 0.25, cube_y + 0.68, cube_z + 0.725));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b - 0.06));
	modelForPawn = alTogether * translate * scale;
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.065 + .115 + 0.25, cube_y + 0.68, cube_z + 0.86 - 0.025));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b - 0.06));
	modelForPawn = alTogether * translate * scale;
	...
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.070 + 0.25, cube_y + .65, cube_z + 0.725));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b + 0.02));
	rotate = glm::mat4(1.0f);
	rotate = glm::rotate(identityMatrix, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	modelForPawn = alTogether * translate * rotate * scale;
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.065 + 0.25, cube_y + .68, cube_z + 0.725));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b - 0.06));
	rotate = glm::mat4(1.0f);
	rotate = glm::rotate(identityMatrix, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	modelForPawn = alTogether * translate * rotate * scale;
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + .15 + 0.25, cube_y + .68, cube_z + 0.735));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b - 0.06));
	rotate = glm::mat4(1.0f);
	rotate = glm::rotate(identityMatrix, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	modelForPawn = alTogether * translate * rotate * scale;
	...
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.070 + 0.25, cube_y + .65, cube_z + 0.725 + .15));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b + 0.02));
	rotate = glm::mat4(1.0f);
	rotate = glm::rotate(identityMatrix, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	modelForPawn = alTogether * translate * rotate * scale;
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.065 + 0.25, cube_y + .68, cube_z + 0.725 + .15));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b - 0.06));
	rotate = glm::mat4(1.0f);
	rotate = glm::rotate(identityMatrix, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	modelForPawn = alTogether * translate * rotate * scale;
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + .15 + 0.25, cube_y + .68, cube_z + 0.735 + .15));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b - 0.06));
	rotate = glm::mat4(1.0f);
	rotate = glm::rotate(identityMatrix, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	modelForPawn = alTogether * translate * rotate * scale;
...
void rook2(unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float cube_x, float cube_y, float cube_z,
	...
	glm::mat4 rotate;
	rotate = glm::rotate(identityMatrix, glm::radians(rotateAngle_X), glm::vec3(1.0f, 0.0f, 0.0f));
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.55, cube_y + 0.40, cube_z + 0.75));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height, cube_w, cube_b));
	modelForPawn = alTogether * translate * scale;
	lightingShader.setMat4("model", modelForPawn);
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.58, cube_y + 0.5, cube_z + 0.75));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.055, cube_w + 0.025, cube_b));
	modelForPawn = alTogether * translate * scale;
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.57, cube_y + 0.6, cube_z + 0.725));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.025, cube_w - 0.05, cube_b + 0.05));
	modelForPawn = alTogether * translate * scale;
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.57, cube_y + 0.65, cube_z + 0.725));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b + 0.05));
	modelForPawn = alTogether * translate * scale;
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.57, cube_y + 0.68, cube_z + 0.725));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b - 0.06));
	modelForPawn = alTogether * translate * scale;
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.57, cube_y + 0.68, cube_z + 0.86 - 0.025));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b - 0.06));
	modelForPawn = alTogether * translate * scale;
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.57 + .115, cube_y + 0.65, cube_z + 0.725));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b + 0.05));
	modelForPawn = alTogether * translate * scale;
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.57 + .115, cube_y + 0.68, cube_z + 0.725));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b - 0.06));
	modelForPawn = alTogether * translate * scale;
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.57 + .115, cube_y + 0.68, cube_z + 0.86 - 0.025));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b - 0.06));
	modelForPawn = alTogether * translate * scale;
	...
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.57, cube_y + .65, cube_z + 0.725));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b + 0.02));
	rotate = glm::mat4(1.0f);
	rotate = glm::rotate(identityMatrix, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	modelForPawn = alTogether * translate * rotate * scale;
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.57, cube_y + .68, cube_z + 0.725));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b - 0.06));
	rotate = glm::mat4(1.0f);
	rotate = glm::rotate(identityMatrix, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	modelForPawn = alTogether * translate * rotate * scale;
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.66, cube_y + .68, cube_z + 0.735));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b - 0.06));
	rotate = glm::mat4(1.0f);
	rotate = glm::rotate(identityMatrix, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	modelForPawn = alTogether * translate * rotate * scale;
	...
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.57, cube_y + .65, cube_z + 0.725 + .15));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b + 0.02));
	rotate = glm::mat4(1.0f);
	rotate = glm::rotate(identityMatrix, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	modelForPawn = alTogether * translate * rotate * scale;
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.57, cube_y + .68, cube_z + 0.725 + .15));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b - 0.06));
	rotate = glm::mat4(1.0f);
	rotate = glm::rotate(identityMatrix, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	modelForPawn = alTogether * translate * rotate * scale;
	...
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	translate = glm::translate(identityMatrix, glm::vec3(cube_x + 0.66, cube_y + .68, cube_z + 0.735 + .15));
	scale = glm::scale(identityMatrix, glm::vec3(cube_height - 0.14, cube_w - 0.07, cube_b - 0.06));
	rotate = glm::mat4(1.0f);
	rotate = glm::rotate(identityMatrix, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	modelForPawn = alTogether * translate * rotate * scale;
...
void knight1(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float x, float y, float z, float h, float w,
	float b, float r, float g, float bl) {

	glm::mat4 modelForKnight = glm::mat4(1.0f);
	glm::mat4 translate = glm::mat4(1.0f);
	glm::mat4 scale = glm::mat4(1.0f);
	glm::mat4 rotate = glm::mat4(1.0f);
	translate = glm::translate(modelForKnight, glm::vec3(x + 0.5f - 0.75f, y, z));
	scale = glm::scale(modelForKnight, glm::vec3(h - 0.25f, w, b));
	modelForKnight = alTogether * translate * scale;
	drawCurve(bezierVAO, lightingShader, modelForKnight, r, g, bl);

	//glm::mat4 modelForKnight, translate, scale, rotate;
	modelForKnight = glm::mat4(1.0f);
	translate = glm::mat4(1.0f);
	scale = glm::mat4(1.0f);
	rotate = glm::mat4(1.0f);
	modelForKnight = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelForKnight, x + 0.5f - 0.75f, 0.60, z, 0.09f, 0.03f, 0.09f, r, g, bl);
	...
	rotate = glm::mat4(1.0f);
	modelForKnight = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelForKnight, x + 0.5f - 0.75f, 0.505, z, 0.105f, 0.045f, 0.105f, r, g, bl);
	...
	rotate = glm::mat4(1.0f);
	modelForKnight = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelForKnight, x + 0.5f - 0.75f, 0.325, z, 0.15f, 0.075f, 0.15f, r, g, bl);
	...
	rotate = glm::mat4(1.0f);
	modelForKnight = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelForKnight, x + 0.5f - 0.75f, 0.625, z, 0.04f, 0.04f, 0.04f, r, g, bl);*/

}



void knight2(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float x, float y, float z, float h, float w,
	float b, float r, float g, float bl) {
	...
	glm::mat4 scale = glm::mat4(1.0f);
	glm::mat4 rotate = glm::mat4(1.0f);
	translate = glm::translate(modelForKnight, glm::vec3(x + 0.5f + 0.5f, y, z));
	scale = glm::scale(modelForKnight, glm::vec3(h - 0.25f, w, b));
	modelForKnight = alTogether * translate * scale;
	drawCurve(bezierVAO, lightingShader, modelForKnight, r, g, bl);
	...
	rotate = glm::mat4(1.0f);
	modelForKnight = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelForKnight, x + 0.5f + 0.5f, 0.60, z, 0.09f, 0.03f, 0.09f, r, g, bl);
	...
	rotate = glm::mat4(1.0f);
	modelForKnight = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelForKnight, x + 0.5f + 0.5f, 0.505, z, 0.105f, 0.045f, 0.105f, r, g, bl);
	...
	rotate = glm::mat4(1.0f);
	modelForKnight = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelForKnight, x + 0.5f + 0.5f, 0.325, z, 0.15f, 0.075f, 0.15f, r, g, bl);
	...
	rotate = glm::mat4(1.0f);
	modelForKnight = alTogether * translate * scale;
	drawSphere(lightingShader, alTogether * modelForKnight, x + 0.5f + 0.5f, 0.625, z, 0.04f, 0.04f, 0.04f, r, g, bl);*/
...
void knight3(unsigned int& bezierVAO, unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether, float x, float y, float z, float h, float w,
	...
	glm::mat4 rotate = glm::mat4(1.0f);
	translate = glm::translate(modelForKnight, glm::vec3(x + 0.5f - 0.75f, y, z));
	scale = glm::scale(modelForKnight, glm::vec3(h - 0.3f, w, b));
	modelForKnight = alTogether * translate * scale;
	drawCurve(bezierVAO, lightingShader, modelForKnight, r, g, bl);
